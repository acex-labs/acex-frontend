...
export const NetworkModule = {
  ...
  routes: [
    ...
    { path: '/network/logical-nodes/:id', load: () => import('../../pages/network/LogicalNodePage') },
    { path: '/network/assets',            load: () => import('../../pages/network/AssetsPage') },
    { path: '/network/assets/:id',        load: () => import('../../pages/network/AssetPage') },
    { path: '/network/asset-clusters/:id', load: () => import('../../pages/network/AssetClusterPage') },
